...
// 繝ｭ繧ｰ繧､繝ｳ蠕後↓雉ｼ蜈･繧貞ｮ御ｺ・＠縲｀y Payment Options 縺九ｉ譁ｰ縺励＞繧ｫ繝ｼ繝峨ｒ霑ｽ蜉縺吶ｋ繧ｷ繝翫Μ繧ｪ
test("add-payment-method", async ({ page }) => {
  ...
  // Account 竊・Orders & Payment 竊・My Payment Options 縺ｮ鬆・〒遘ｻ蜍輔☆繧九・
  ...
  // Add new card 繧偵け繝ｪ繝・け縺励※螻暮幕縺吶ｋ縲・
  await page.getByRole("button", { name: /Add new card/i }).click();

  // 繧ｫ繝ｼ繝画ュ蝣ｱ繧貞・蜉帙＠縺ｦ Submit 繧呈款縺吶・
